...
(async () => {
    ...
    const evaluationResult = await page.evaluate(({ newJson, configFile }) => {
      ...
      for(i = 0; i < deepSearchInputEmptyNodesUnchecked.length; i++){
      ...
      for(i = 0; i < deepSearchInputEmptyEdgesUnchecked.length; i++){
      ...
      const deepSearchInputWrongEdgesUnchecked = [...ge.graphtool.edges.get()]
        ...
        for(i = 0; i < deepSearchInputWrongNodesUnchecked.length; i++){
        ...
        for(i = 0; i < deepSearchInputWrongEdgesUnchecked.length; i++){
        ...
        let deepSearchTenInputNodes = [...ge.graphtool.nodes.get()]
        let deepSearchTenInputEdges = [...ge.graphtool.edges.get()]
        ...
        let deepSearchInputEmptyNodesChecked = [...ge.graphtool.nodes.get()]
        let deepSearchInputEmptyEdgesChecked = [...ge.graphtool.edges.get()]
        ...
        let deepSearchInputWrongNodesChecked = [...ge.graphtool.nodes.get()]
        let deepSearchInputWrongEdgesChecked = [...ge.graphtool.edges.get()]
      ...
      let expandedNode1 = [ge.graphtool.nodes.get("jsondata/Item:MyProject/budget/2/year").id]
      let exoandedNode2 = [ge.graphtool.nodes.get("jsondata/Item:MyProject/budget/2/value").id]
      let expectedOpenNode1 = ["jsondata/Item:MyProject/budget/2/year"]
      let expectedOpenNode2 = ["jsondata/Item:MyProject/budget/2/value"]
