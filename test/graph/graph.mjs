...
//       test('Does given Node has an outgoing Edge ', async assert => {
//           assert.plan(2);
//           assert.ok(evaluationResult.result, "The Node does not have an outgoing Edge");
//           assert.notOk(evaluationResult.result2, "The Node has an outgoing Edge");
//       });
//   }
